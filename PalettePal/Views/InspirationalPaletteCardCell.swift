...
class InspirationalPaletteCardCell: UICollectionViewCell {
    ...
    private func setupSubviews() {
        ...
        NSLayoutConstraint.activate([
            ...
            inspirationalImageView.heightAnchor.constraint(equalTo: containerView.heightAnchor, multiplier: 0.75),
            ...
            paletteCard.topAnchor.constraint(equalTo: inspirationalImageView.bottomAnchor, constant: 4),
